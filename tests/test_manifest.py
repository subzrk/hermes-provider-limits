...
def test_requires_hermes_floor_matches_the_sdk_release_that_added_i18n():
    # The v2026.7.20 release is the first whose plugin SDK exports usePluginI18n
    # and the Select primitives; it ships hermes 0.19.0.
    version_satisfies = pytest.importorskip(
        'hermes_cli.plugins_manifest').version_satisfies
